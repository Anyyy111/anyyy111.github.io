...
function text1(){
    document.getElementById('love').innerHTML = "你是落日弥漫的橘，天边透亮的星✨"; 
}

function textp2(){
    document.getElementById('love').innerHTML += "</br>是微风，是晚霞，是心跳，是无可替代</br>"
}
...
function text4(){
    document.getElementById('love').innerHTML += "</br>尽我所能，顾你冷暖，";
}
function text5(){
    document.getElementById('love').innerHTML += "</br>尽我所爱，许你一生。";
}
function text6(){
    document.getElementById('love').innerHTML += "</br>My Wasted Heart Will Love You Forever. 520快乐❤️";
}
...
function Rise() {
    ...
    timer2 = setInterval(() => {
        ...
        if (distance >= target) {
            ...
            setTimeout(text5,10000);
            setTimeout(text6,13000);
        }
